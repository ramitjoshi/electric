...
<form name="edit_vehicle" id="edit_vehicle" action="" method="post"> 
	...
	<div class="cstm-wid top_inpt">    
		<ul> 
			<li> 
				<input class="numbersOnly" type="text" name="vehicle_num" placeholder="Vehicle #" value="<?php echo get_vehicle_info($vehicle_id,'vehicle_num'); ?>" maxlength="8">
			</li> 
			<li>
			...
			<li>
				<input type="text" name="km" placeholder="KMs (start of year)" value="<?php echo get_vehicle_info($vehicle_id,'km'); ?>"> 
			</li> 
		</ul> 
	</div>
	...
	<div class="btn_deit">
		...
		{	
		?>
			<div class="freeze_ac"><a class="custom edit_cstm" href="javascript:void(0);" onclick="freeze_vehicle('<?php echo $vehicle_id; ?>','0');">Freeze</a></div>
		<?php
		}
		else
		{	
		?>
			<div class="freeze_ac"><a class="custom edit_cstm" href="javascript:void(0);" onclick="freeze_vehicle('<?php echo $vehicle_id; ?>','1');">UnFreeze</a></div>
		<?php
		}
		?>
