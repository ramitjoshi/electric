...
<div class="inner_pdng">
	<form name="editTimeCardd" id="editTimeCardd" action="" method="post">
		...
		<div class="selectn_boxx"> 
			<ul>
				<li class="pull-left">
					...
					<input placeholder="Description" name="veh_descp" value="Doug Werner" type="text" value="<?php echo get_timecard_vehicle_info($id,'descp'); ?>">
				</li><li>
...
<div class="inner_content">
	...
	<div class="inner_pdng">
	<form name="new_timecardd" id="new_timecardd" action="" method="post" target="_blank">
			...
			<div class="selectn_boxx"> 
				<ul>
					<li class="pull-left">
						...
						<input placeholder="Description" name="veh_descp" type="text" value="<?php echo $cust_cmp;  ?>">
					<li>
					<li class="pull-right">
