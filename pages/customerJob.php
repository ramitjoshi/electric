            ...
            <div class="close_mn closed_cont display_block">
				...
				<div class="timecard_box">
					<div class="time_cont display_block">
						...
						<div class="tim_rt pull-left" style="width:45%">
							<table>
								<tbody>
									...
									?>
									<tr>
										<td style="width: 31%; padding: 19px 3%;"><?php echo get_user_detail($row_staff['staff_id'],'first_name'); ?> <?php echo get_user_detail($row_staff['staff_id'],'last_name'); ?></td>
						...
						<div class="tim_rt new_vehicle pull-left" style="width:50%">
						<table>
								<tbody>
									<?php
