        ...
        <div class="rt_sidebar pull-left cstmr_rt">
            <div class="btns_top display_block">
                <div class="btns_lft pull-left">
					...
					?>
					<a onclick="jQuery('.box').slideUp();jQuery('.add_milege').slideDown();" class="custom" href="javascript:void(0);">New Record</a>
					<a class="custom" href="javascript:void(0);" onclick="jQuery('.box').slideUp();jQuery('.gen_report').slideDown();">New Report</a>
            ...
            <div class="close_mn display_block">
				...
				<div id="fromToggle" class="collapsible-area box" style="display:none">	</div>
				<div  class="add_milege box" style="display:none">	
					 <div class="new_custmer">
						<a href="javascript:void(0);" onclick="jQuery('.box').slideUp();" class="close_new"><i class="fa fa-times" aria-hidden="true"></i></a> 
				...
				<div  class="gen_report box gen_btn" style="display:none">	
					 <div class="new_custmer">
						<a href="javascript:void(0);" onclick="jQuery('.box').slideUp();" class="close_new"><i class="fa fa-times" aria-hidden="true"></i></a>  
						<h4 class="close_title">GENERATE REPORT</h4></div>
						<div class="close_container custmr_edt_cnt">
							
								<div class="cstm-wid top_inpt asign-left"> 
									<form name="gen_veh_report" id="gen_veh_report" action="" method="post">
									<input type="hidden" name="action" value="GenVehicleReport">	
										<ul>   
											<li>
												<input name="rep_start_date" placeholder="Start Date" type="text" class="datepicker">
											</li>
											<li>
												<input name="rep_end_date" placeholder="End Date" type="text" class="datepicker">
											</li>
											<li>
												<select name="rep_veh_id"> 
												<option value="">Select Vehicle</option>
												<?php
												$sql="select * from vehicle where status='1' order by id desc";
												$res=mysql_query($sql);
										...
										<div class="btn_deit ">
											<button type="submit" class="custom edit_cstm veh_rep_btn">Submit</button>
											<img src="assets/images/loader.gif" id="gen_veh_rep_ld" style="display:none;" />
											<div class="gen_rep_box"></div>
										</div> 
									</form>	
								</div>
                ...
                <div class="box add_cust_box" style="display:none;">
					...
					<form name="add_vehicle" id="add_vehicle" action="" method="post"> 
						...
						<div class="cstm-wid top_inpt">  
							<ul>
								<li>
									<input class="" type="text" name="vehicle_num" placeholder="Vehicle #" maxlength="8">
								</li> 
								<li>
								...
								<li>
									<input type="text" name="km" class="format" placeholder="KMs (start of year)">
								</li> 
							</ul> 
						</div>
                ...
                <div class="edit_table">
					<div class="new_custmer">
						<h4 class="close_title">ACTIVE VEHICLE</h4>
					</div>
					<?php
				 ...
				 <div class="edit_table">
					<div class="new_custmer">
						<h4 class="close_title">INACTIVE VEHICLE</h4>
					</div>
					<?php
