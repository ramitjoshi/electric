...
$sql_g="select * from report_gen where user_id='".$_GET['user_id']."'";
...
<div class="logo" style="text-align: center;display:inline-block;width:100%;margin:0 0 30px;">
             <img alt="" src="http://i.imgur.com/r1XZszq.jpg">
</div>
<div class="configure">
...
<div class="configure-details">
	<div style="float:left;font-size:13px;border:0;width:67%">'.get_cust_detail($cust_id,'company').' - '.get_cust_detail($cust_id,'work_add1').' '.get_cust_detail($cust_id,'work_add2').', '.get_cust_detail($cust_id,'work_city').' '.get_cust_detail($cust_id,'work_prov').' '.get_cust_detail($cust_id,'work_post_code').'</div> 
...
<div class="configure-details">
	<div style="float:left;font-size:13px;border:0;width:100%">'.$summary.'</div>
</div>	
