...
$staff_f=$_REQUEST['staff_id'];

foreach($staff_f as $val)
{
	$asd .=$val.",";
}

$staff_id=substr($asd,0,-1);


$curr_monday=$_REQUEST['curr_monday'];
$curr_sunday=$_REQUEST['curr_sunday'];
...
<body style="font-family: Open Sans, sans-serif;">
	<div style="padding-top:20px;"><div class="logo">
		   <img alt="" src="http://i.imgur.com/r1XZszq.jpg" style="display:block; margin:0 auto; width:450px;">
	</div>
	<table width="100%">
	<tbody>
		<tr>
			...
			<div class="clndr_rt">
				<div class="recen_cont display_block" style="margin:0 2px;">
					<div class="inner_pdng">
						<span class="date pull-left">'.date('M', strtotime($monday)).' '.date('d', strtotime($monday)).'-'.date('d', strtotime($saturday)).', '.date('Y', strtotime($saturday)).'</span></div> 
				</div>
